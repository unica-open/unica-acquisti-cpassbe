...
public class OutputParameters {
    ...
    @XmlElementRef(name = "OP_COD_STRUTTURA", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_consiglio_reg/get_dati_assegnazione/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opcodstruttura;
    @XmlElementRef(name = "OP_COD_REGIONALE", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_consiglio_reg/get_dati_assegnazione/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opcodregionale;
    @XmlElementRef(name = "OP_NOME_UO", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_consiglio_reg/get_dati_assegnazione/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opnomeuo;
    @XmlElementRef(name = "OP_COD_MANSIONE", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_consiglio_reg/get_dati_assegnazione/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opcodmansione;
    @XmlElementRef(name = "OP_DES_MANSIONE", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_consiglio_reg/get_dati_assegnazione/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opdesmansione;
    @XmlElementRef(name = "OP_COD_PROFILO_PROFESS", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_consiglio_reg/get_dati_assegnazione/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opcodprofiloprofess;
    @XmlElementRef(name = "OP_DES_PROFILO_PROFESS", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_consiglio_reg/get_dati_assegnazione/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opdesprofiloprofess;
    @XmlElementRef(name = "OP_COD_UBICAZIONE", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_consiglio_reg/get_dati_assegnazione/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opcodubicazione;
    @XmlElementRef(name = "OP_DES_UBICAZIONE", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_consiglio_reg/get_dati_assegnazione/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opdesubicazione;
    @XmlElementRef(name = "OP_COD_POSIZIONE", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_consiglio_reg/get_dati_assegnazione/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opcodposizione;
    @XmlElementRef(name = "OP_DES_POSIZIONE", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_consiglio_reg/get_dati_assegnazione/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opdesposizione;
    @XmlElementRef(name = "OP_COD_TIPO_RAPP_LAV", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_consiglio_reg/get_dati_assegnazione/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opcodtiporapplav;
    @XmlElementRef(name = "OP_DES_TIPO_RAPP_LAV", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_consiglio_reg/get_dati_assegnazione/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opdestiporapplav;
    @XmlElementRef(name = "OP_COD_RUOLO_ESTERNO", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_consiglio_reg/get_dati_assegnazione/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opcodruoloesterno;
    @XmlElementRef(name = "OP_DES_RUOLO_ESTERNO", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_consiglio_reg/get_dati_assegnazione/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opdesruoloesterno;
    @XmlElementRef(name = "OP_COD_STATO_ASSEGN", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_consiglio_reg/get_dati_assegnazione/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opcodstatoassegn;
    @XmlElementRef(name = "OP_DES_STATO_ASSEGN", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_consiglio_reg/get_dati_assegnazione/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opdesstatoassegn;
    @XmlElementRef(name = "OP_FLAG_RESPONSABILE", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_consiglio_reg/get_dati_assegnazione/", type = JAXBElement.class, required = false)
    protected JAXBElement<Integer> opflagresponsabile;
    @XmlElementRef(name = "OP_COD_CONTRATTO", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_consiglio_reg/get_dati_assegnazione/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opcodcontratto;
    @XmlElementRef(name = "OP_DES_CONTRATTO", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_consiglio_reg/get_dati_assegnazione/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opdescontratto;
    @XmlElementRef(name = "OP_DATA_CONTRATTO", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_consiglio_reg/get_dati_assegnazione/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opdatacontratto;
    @XmlElementRef(name = "OP_COD_PROFILO", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_consiglio_reg/get_dati_assegnazione/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opcodprofilo;
    @XmlElementRef(name = "OP_DES_PROFILO", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_consiglio_reg/get_dati_assegnazione/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opdesprofilo;
    @XmlElementRef(name = "OP_COD_POS_ECONOMICA", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_consiglio_reg/get_dati_assegnazione/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opcodposeconomica;
    @XmlElementRef(name = "OP_DES_POS_ECONOMICA", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_consiglio_reg/get_dati_assegnazione/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opdesposeconomica;
    @XmlElementRef(name = "OP_COD_ORARIO", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_consiglio_reg/get_dati_assegnazione/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opcodorario;
    @XmlElementRef(name = "OP_DES_ORARIO", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_consiglio_reg/get_dati_assegnazione/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opdesorario;
    @XmlElementRef(name = "OP_COD_CAPITOLO", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_consiglio_reg/get_dati_assegnazione/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opcodcapitolo;
    @XmlElementRef(name = "OP_DES_CAPITOLO", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_consiglio_reg/get_dati_assegnazione/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opdescapitolo;
    @XmlElementRef(name = "OP_COD_RAGGR_CED", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_consiglio_reg/get_dati_assegnazione/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opcodraggrced;
    @XmlElementRef(name = "OP_DES_RAGGR_CED", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_consiglio_reg/get_dati_assegnazione/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opdesraggrced;
    @XmlElementRef(name = "OP_COD_PROGR_ECO", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_consiglio_reg/get_dati_assegnazione/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opcodprogreco;
    @XmlElementRef(name = "OP_DES_PROGR_ECO", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_consiglio_reg/get_dati_assegnazione/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opdesprogreco;
    @XmlElementRef(name = "OP_LIBRO_MATR_INAIL", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_consiglio_reg/get_dati_assegnazione/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> oplibromatrinail;
    @XmlElementRef(name = "OP_COD_MOD_ASSUNZIONE", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_consiglio_reg/get_dati_assegnazione/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opcodmodassunzione;
    @XmlElementRef(name = "OP_DES_MOD_ASSUNZIONE", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_consiglio_reg/get_dati_assegnazione/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opdesmodassunzione;
    @XmlElementRef(name = "OP_DATA_SCAD_CONTR", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_consiglio_reg/get_dati_assegnazione/", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> opdatascadcontr;
    @XmlElementRef(name = "OP_DATA_ENTR_RUOLO", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_consiglio_reg/get_dati_assegnazione/", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> opdataentrruolo;
    @XmlElementRef(name = "OP_PERC_SCAVALCO", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_consiglio_reg/get_dati_assegnazione/", type = JAXBElement.class, required = false)
    protected JAXBElement<BigDecimal> oppercscavalco;
    @XmlElementRef(name = "OP_PERC_PART_TIME", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_consiglio_reg/get_dati_assegnazione/", type = JAXBElement.class, required = false)
    protected JAXBElement<BigDecimal> oppercparttime;
    @XmlElementRef(name = "OP_PERC_PART_TIME_V", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_consiglio_reg/get_dati_assegnazione/", type = JAXBElement.class, required = false)
    protected JAXBElement<BigDecimal> oppercparttimev;
    @XmlElementRef(name = "OP_PERC_ORARIO_RID", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_consiglio_reg/get_dati_assegnazione/", type = JAXBElement.class, required = false)
    protected JAXBElement<BigDecimal> oppercorariorid;
    @XmlElementRef(name = "OP_COD_REAS_ANNOT", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_consiglio_reg/get_dati_assegnazione/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opcodreasannot;
    @XmlElementRef(name = "OP_DES_REAS_ANNOT", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_consiglio_reg/get_dati_assegnazione/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opdesreasannot;
    @XmlElementRef(name = "OP_MSG_DATA", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_consiglio_reg/get_dati_assegnazione/", type = JAXBElement.class, required = false)
