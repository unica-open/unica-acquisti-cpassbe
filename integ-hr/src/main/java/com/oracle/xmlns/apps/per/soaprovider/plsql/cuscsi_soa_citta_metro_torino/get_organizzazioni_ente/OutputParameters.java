 ...
 *         &amp;lt;element name="OP_IDENTIFICATIVO_UO" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&amp;gt;
...
public class OutputParameters {
    ...
    @XmlElementRef(name = "OP_NOME", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_citta_metro_torino/get_organizzazioni_ente/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opnome;
    @XmlElementRef(name = "OP_COD_TIPOLOGIA", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_citta_metro_torino/get_organizzazioni_ente/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opcodtipologia;
    @XmlElementRef(name = "OP_DES_TIPOLOGIA", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_citta_metro_torino/get_organizzazioni_ente/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opdestipologia;
    @XmlElementRef(name = "OP_DATA_INIZIO", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_citta_metro_torino/get_organizzazioni_ente/", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> opdatainizio;
    @XmlElementRef(name = "OP_DATA_FINE", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_citta_metro_torino/get_organizzazioni_ente/", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> opdatafine;
    @XmlElementRef(name = "OP_COD_UBICAZIONE", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_citta_metro_torino/get_organizzazioni_ente/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opcodubicazione;
    @XmlElementRef(name = "OP_DESCRIZIONE_ESTESA", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_citta_metro_torino/get_organizzazioni_ente/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opdescrizioneestesa;
    @XmlElementRef(name = "OP_COD_STRUTTURA", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_citta_metro_torino/get_organizzazioni_ente/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opcodstruttura;
    @XmlElementRef(name = "OP_PROVVEDIMENTO", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_citta_metro_torino/get_organizzazioni_ente/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opprovvedimento;
    @XmlElementRef(name = "OP_DATA_PROVVEDIMENTO", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_citta_metro_torino/get_organizzazioni_ente/", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> opdataprovvedimento;
    @XmlElementRef(name = "OP_TELEFONO", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_citta_metro_torino/get_organizzazioni_ente/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> optelefono;
    @XmlElementRef(name = "OP_TELEFONO2", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_citta_metro_torino/get_organizzazioni_ente/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> optelefono2;
    @XmlElementRef(name = "OP_TELEFONO3", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_citta_metro_torino/get_organizzazioni_ente/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> optelefono3;
    @XmlElementRef(name = "OP_FAX", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_citta_metro_torino/get_organizzazioni_ente/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opfax;
    @XmlElementRef(name = "OP_EMAIL", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_citta_metro_torino/get_organizzazioni_ente/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opemail;
    @XmlElementRef(name = "OP_AOO", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_citta_metro_torino/get_organizzazioni_ente/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opaoo;
    @XmlElementRef(name = "OP_IDENTIFICATIVO_UO", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_citta_metro_torino/get_organizzazioni_ente/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opidentificativouo;
    @XmlElementRef(name = "OP_ORIGINE_STRUTTURA", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_citta_metro_torino/get_organizzazioni_ente/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> oporiginestruttura;
    @XmlElementRef(name = "OP_COD_STRUTTURA_PADRE", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_citta_metro_torino/get_organizzazioni_ente/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opcodstrutturapadre;
    @XmlElementRef(name = "OP_COD_TIPOLOGIA_PADRE", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_citta_metro_torino/get_organizzazioni_ente/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opcodtipologiapadre;
    @XmlElementRef(name = "OP_MSG_DATA", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_citta_metro_torino/get_organizzazioni_ente/", type = JAXBElement.class, required = false)
    ...
    /**
     * Recupera il valore della proprietà opidentificativouo.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public JAXBElement<String> getOPIDENTIFICATIVOUO() {
        return opidentificativouo;
    }

    /**
     * Imposta il valore della proprietà opidentificativouo.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setOPIDENTIFICATIVOUO(JAXBElement<String> value) {
        this.opidentificativouo = value;
    }
