 ...
 *       &amp;lt;sequence&amp;gt;
 *         &amp;lt;element name="CUSCSI_SOA_CITTA_METRO_TORIN1" type="{http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_citta_metro_torino/get_tipologia_org_ente/}APPS.CUSCSI_SOA_CITTAX5117453X5X1" minOccurs="0"/&amp;gt;
...
public class OutputParameters {
    ...
    @XmlElementRef(name = "CUSCSI_SOA_CITTA_METRO_TORIN1", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_citta_metro_torino/get_tipologia_org_ente/", type = JAXBElement.class, required = false)
    protected JAXBElement<APPSCUSCSISOACITTAX5117453X5X1> cuscsisoacittametrotorin1;
    @XmlElementRef(name = "OP_COD_TIPOLOGIA", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_citta_metro_torino/get_tipologia_org_ente/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opcodtipologia;
    @XmlElementRef(name = "OP_DES_TIPOLOGIA", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_citta_metro_torino/get_tipologia_org_ente/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opdestipologia;
    @XmlElementRef(name = "OP_DATA_INIZIO", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_citta_metro_torino/get_tipologia_org_ente/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opdatainizio;
    @XmlElementRef(name = "OP_DATA_FINE", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_citta_metro_torino/get_tipologia_org_ente/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opdatafine;
    @XmlElementRef(name = "OP_MSG_DATA", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_citta_metro_torino/get_tipologia_org_ente/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opmsgdata;

    /**
     * Recupera il valore della proprietà cuscsisoacittametrotorin1.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link APPSCUSCSISOACITTAX5117453X5X1 }{@code >}
     *     
     */
    public JAXBElement<APPSCUSCSISOACITTAX5117453X5X1> getCUSCSISOACITTAMETROTORIN1() {
        return cuscsisoacittametrotorin1;
    }

    /**
     * Imposta il valore della proprietà cuscsisoacittametrotorin1.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link APPSCUSCSISOACITTAX5117453X5X1 }{@code >}
     *     
     */
    public void setCUSCSISOACITTAMETROTORIN1(JAXBElement<APPSCUSCSISOACITTAX5117453X5X1> value) {
        this.cuscsisoacittametrotorin1 = value;
    }
