 ...
 *       &amp;lt;sequence&amp;gt;
 *         &amp;lt;element name="CUSCSI_SOA_COMUNE_TORINO-24GET_" type="{http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_comune_torino/get_tipologia_org_ente/}APPS.CUSCSI_SOA_COMUNX5117455X5X1" minOccurs="0"/&amp;gt;
...
public class OutputParameters {
    ...
    @XmlElementRef(name = "CUSCSI_SOA_COMUNE_TORINO-24GET_", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_comune_torino/get_tipologia_org_ente/", type = JAXBElement.class, required = false)
    protected JAXBElement<APPSCUSCSISOACOMUNX5117455X5X1> cuscsisoacomunetorino24GET;
    @XmlElementRef(name = "OP_COD_TIPOLOGIA", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_comune_torino/get_tipologia_org_ente/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opcodtipologia;
    @XmlElementRef(name = "OP_DES_TIPOLOGIA", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_comune_torino/get_tipologia_org_ente/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opdestipologia;
    @XmlElementRef(name = "OP_DATA_INIZIO", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_comune_torino/get_tipologia_org_ente/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opdatainizio;
    @XmlElementRef(name = "OP_DATA_FINE", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_comune_torino/get_tipologia_org_ente/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opdatafine;
    @XmlElementRef(name = "OP_MSG_DATA", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_comune_torino/get_tipologia_org_ente/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opmsgdata;

    /**
     * Recupera il valore della proprietà cuscsisoacomunetorino24GET.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link APPSCUSCSISOACOMUNX5117455X5X1 }{@code >}
     *     
     */
    public JAXBElement<APPSCUSCSISOACOMUNX5117455X5X1> getCUSCSISOACOMUNETORINO24GET() {
        return cuscsisoacomunetorino24GET;
    }

    /**
     * Imposta il valore della proprietà cuscsisoacomunetorino24GET.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link APPSCUSCSISOACOMUNX5117455X5X1 }{@code >}
     *     
     */
    public void setCUSCSISOACOMUNETORINO24GET(JAXBElement<APPSCUSCSISOACOMUNX5117455X5X1> value) {
        this.cuscsisoacomunetorino24GET = value;
    }
