...
public class InputParameters {
    ...
    @XmlElementRef(name = "P_COD_STRUTTURA", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_giunta_regionale/get_organizzazioni_ente/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> pcodstruttura;
    @XmlElementRef(name = "P_NOME", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_giunta_regionale/get_organizzazioni_ente/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> pnome;
    @XmlElementRef(name = "P_DATA_ESTRAZIONE", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_giunta_regionale/get_organizzazioni_ente/", type = JAXBElement.class, required = false)
