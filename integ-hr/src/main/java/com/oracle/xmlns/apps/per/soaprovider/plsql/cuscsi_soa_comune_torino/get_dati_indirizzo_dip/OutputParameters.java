...
public class OutputParameters {
    ...
    @XmlElementRef(name = "OP_TIPOLOGIA", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_comune_torino/get_dati_indirizzo_dip/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> optipologia;
    @XmlElementRef(name = "OP_INDIRIZZO", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_comune_torino/get_dati_indirizzo_dip/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opindirizzo;
    @XmlElementRef(name = "OP_CIVICO", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_comune_torino/get_dati_indirizzo_dip/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opcivico;
    @XmlElementRef(name = "OP_BIS_INTERNO_LETT", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_comune_torino/get_dati_indirizzo_dip/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opbisinternolett;
    @XmlElementRef(name = "OP_CAP", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_comune_torino/get_dati_indirizzo_dip/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opcap;
    @XmlElementRef(name = "OP_CITTA", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_comune_torino/get_dati_indirizzo_dip/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opcitta;
    @XmlElementRef(name = "OP_PROVINCIA", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_comune_torino/get_dati_indirizzo_dip/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opprovincia;
    @XmlElementRef(name = "OP_NAZIONE", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_comune_torino/get_dati_indirizzo_dip/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opnazione;
    @XmlElementRef(name = "OP_TELEFONO", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_comune_torino/get_dati_indirizzo_dip/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> optelefono;
    @XmlElementRef(name = "OP_ALTRO_TELEFONO", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_comune_torino/get_dati_indirizzo_dip/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opaltrotelefono;
    @XmlElementRef(name = "OP_MSG_DATA", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_comune_torino/get_dati_indirizzo_dip/", type = JAXBElement.class, required = false)
