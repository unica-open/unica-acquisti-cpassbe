...
public class InputParameters {
    ...
    @XmlElementRef(name = "P_MATRICOLA_HR", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_giunta_regionale/get_dati_indirizzo_dip/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> pmatricolahr;
    @XmlElementRef(name = "P_CODICE_FISCALE", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_giunta_regionale/get_dati_indirizzo_dip/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> pcodicefiscale;
    @XmlElementRef(name = "P_DATA_ESTRAZIONE", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_giunta_regionale/get_dati_indirizzo_dip/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> pdataestrazione;
    @XmlElementRef(name = "P_PRINCIPALE", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_giunta_regionale/get_dati_indirizzo_dip/", type = JAXBElement.class, required = false)
