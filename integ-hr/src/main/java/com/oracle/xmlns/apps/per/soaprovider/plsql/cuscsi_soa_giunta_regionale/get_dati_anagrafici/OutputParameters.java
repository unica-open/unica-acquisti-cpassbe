...
public class OutputParameters {
    ...
    @XmlElementRef(name = "OP_MATRICOLA_HR", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_giunta_regionale/get_dati_anagrafici/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opmatricolahr;
    @XmlElementRef(name = "OP_CODICE_FISCALE", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_giunta_regionale/get_dati_anagrafici/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opcodicefiscale;
    @XmlElementRef(name = "OP_COGNOME_NOME", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_giunta_regionale/get_dati_anagrafici/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opcognomenome;
    @XmlElementRef(name = "OP_COGNOME", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_giunta_regionale/get_dati_anagrafici/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opcognome;
    @XmlElementRef(name = "OP_NOME", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_giunta_regionale/get_dati_anagrafici/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opnome;
    @XmlElementRef(name = "OP_SESSO", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_giunta_regionale/get_dati_anagrafici/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opsesso;
    @XmlElementRef(name = "OP_DATA_NASCITA", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_giunta_regionale/get_dati_anagrafici/", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> opdatanascita;
    @XmlElementRef(name = "OP_COD_NAZIONE_NASCITA", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_giunta_regionale/get_dati_anagrafici/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opcodnazionenascita;
    @XmlElementRef(name = "OP_DES_NAZIONE_NASCITA", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_giunta_regionale/get_dati_anagrafici/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opdesnazionenascita;
    @XmlElementRef(name = "OP_COD_LUOGO_NASCITA", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_giunta_regionale/get_dati_anagrafici/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opcodluogonascita;
    @XmlElementRef(name = "OP_DES_LUOGO_NASCITA", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_giunta_regionale/get_dati_anagrafici/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opdesluogonascita;
    @XmlElementRef(name = "OP_EX_COD_ENTE", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_giunta_regionale/get_dati_anagrafici/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opexcodente;
    @XmlElementRef(name = "OP_DES_EX_COD_ENTE", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_giunta_regionale/get_dati_anagrafici/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opdesexcodente;
    @XmlElementRef(name = "OP_EX_MATRICOLA", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_giunta_regionale/get_dati_anagrafici/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opexmatricola;
    @XmlElementRef(name = "OP_TIPO_PERSONA", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_giunta_regionale/get_dati_anagrafici/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> optipopersona;
    @XmlElementRef(name = "OP_CITTADINANZA", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_giunta_regionale/get_dati_anagrafici/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opcittadinanza;
    @XmlElementRef(name = "OP_DATA_PRIMA_ASSUNZIONE", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_giunta_regionale/get_dati_anagrafici/", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> opdataprimaassunzione;
    @XmlElementRef(name = "OP_DATA_ULT_ASSUNZIONE", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_giunta_regionale/get_dati_anagrafici/", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> opdataultassunzione;
    @XmlElementRef(name = "OP_EMAIL", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_giunta_regionale/get_dati_anagrafici/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> opemail;
    @XmlElementRef(name = "OP_MSG_DATA", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_giunta_regionale/get_dati_anagrafici/", type = JAXBElement.class, required = false)
