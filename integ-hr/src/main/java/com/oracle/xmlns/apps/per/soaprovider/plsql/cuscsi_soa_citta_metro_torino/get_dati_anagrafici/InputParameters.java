...
public class InputParameters {
    ...
    @XmlElementRef(name = "P_MATRICOLA_HR", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_citta_metro_torino/get_dati_anagrafici/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> pmatricolahr;
    @XmlElementRef(name = "P_CODICE_FISCALE", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_citta_metro_torino/get_dati_anagrafici/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> pcodicefiscale;
    @XmlElementRef(name = "P_DATA_ESTRAZIONE", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_citta_metro_torino/get_dati_anagrafici/", type = JAXBElement.class, required = false)
