...
/**
 * &lt;p&gt;Classe Java per APPS.CUSCSI_SOA_COMUNX5117455X5X2 complex type.
 * 
 * &lt;p&gt;Il seguente frammento di schema specifica il contenuto previsto contenuto in questa classe.
 * 
 * &lt;pre&gt;
 * &amp;lt;complexType name="APPS.CUSCSI_SOA_COMUNX5117455X5X2"&amp;gt;
 *   &amp;lt;complexContent&amp;gt;
...
@XmlType(name = "APPS.CUSCSI_SOA_COMUNX5117455X5X2", propOrder = {
    "codtipologia",
    "destipologia",
    "datainizio",
    "datafine"
})
public class APPSCUSCSISOACOMUNX5117455X5X2 {

    @XmlElementRef(name = "COD_TIPOLOGIA", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_comune_torino/get_tipologia_org_ente/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> codtipologia;
    @XmlElementRef(name = "DES_TIPOLOGIA", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_comune_torino/get_tipologia_org_ente/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> destipologia;
    @XmlElementRef(name = "DATA_INIZIO", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_comune_torino/get_tipologia_org_ente/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> datainizio;
    @XmlElementRef(name = "DATA_FINE", namespace = "http://xmlns.oracle.com/apps/per/soaprovider/plsql/cuscsi_soa_comune_torino/get_tipologia_org_ente/", type = JAXBElement.class, required = false)
