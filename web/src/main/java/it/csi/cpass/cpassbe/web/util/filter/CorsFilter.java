...
public class CorsFilter implements ContainerResponseFilter {
	...
	private static final String DEFAULT_ALLOWED_HEADERS = "Origin, Accept, Content-Type, Authorization, X-Requested-With, Access-Control-Request-Method, Access-Control-Request-Headers, X-SETTORE";
