 ...
 */
public class GetCaricamentoAggiornamentiImpegniRequest implements BaseRequest {
	String ente;
	Integer numelab;
	String dataElab;
	public GetCaricamentoAggiornamentiImpegniRequest(String ente, Integer numelab,String dataElab) {
		super();
		this.ente = ente;
