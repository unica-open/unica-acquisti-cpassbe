...
public class GetPermessiDaGestireRequest extends BasePagedRequest {

	public GetPermessiDaGestireRequest(Integer page, Integer size, String sort, String direction) {
