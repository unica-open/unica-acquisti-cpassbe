 ...
 */
@Mapper(uses = {RisorsaMapper.class , InterventoMapper.class})
public interface InterventoImportiMapper extends BaseMapperInterface<InterventoImporti, CpassTPbaInterventoImporti> {
