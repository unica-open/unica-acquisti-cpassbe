 ...
 */
public class PutInterventoVolturaRequest implements BaseRequest {
	 ...
	 */
	public PutInterventoVolturaRequest(UUID idSettore, UUID idRup, List<Intervento> listaInterventi) {
	...
	/**
	 * @param idSettore the idSettore to set
	 */
