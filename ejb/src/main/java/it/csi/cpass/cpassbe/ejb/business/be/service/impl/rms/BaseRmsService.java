 ...
 */
public abstract class BaseRmsService<Q extends BaseRequest, R extends BaseResponse> extends BaseService<Q, R> {

	/** Data Access Delegate for Rms  */
	protected final RmsDad rmsDad;
	 ...
	 */
	protected BaseRmsService(ConfigurationHelper configurationHelper, RmsDad rmsDad) {
