...
@NamedQuery(name="CpassTOrdSubimpegnoOrdine.findAll", query="SELECT c FROM CpassTOrdSubimpegnoOrdine c")
public class CpassTOrdSubimpegnoOrdine extends BaseAuditedEntity<UUID> implements Serializable {
	private static final long serialVersionUID = 1L;
	/** The UUID namespace */
	public static final UUID NAMESPACE = UuidUtils.generateUUIDv5FromNamespaceAndString(UuidUtils.NAMESPACE_OID, "cpass_t_ord_subimpegno_ordine");
	...
	public CpassTOrdSubimpegnoOrdine() {
	}
