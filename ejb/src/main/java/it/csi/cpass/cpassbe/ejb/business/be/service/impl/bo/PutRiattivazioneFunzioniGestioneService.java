...
public class PutRiattivazioneFunzioniGestioneService extends BaseBoService<PutRiattivazioneFunzioniGestioneRequest, PutRiattivazioneFunzioniGestioneResponse> {
	 ...
	 * Constructor
	 */
	public PutRiattivazioneFunzioniGestioneService(
	...
	public void execute() {
		...
		try {
			...
			for (final Permesso permesso : permessi) {
				decodificaDad.updatePermesso(permesso, Boolean.TRUE);
			}
