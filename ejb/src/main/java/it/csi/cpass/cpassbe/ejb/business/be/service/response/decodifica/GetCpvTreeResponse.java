 ...
 */
public class GetCpvTreeResponse extends BaseGetResponse<List<Cpv>> {
	...
	public String toString() {
		...
		builder.append("GetCpvTreeResponse [cpvs=").append(cpvs).append(", apiErrors=").append(getApiErrors()).append("]");
