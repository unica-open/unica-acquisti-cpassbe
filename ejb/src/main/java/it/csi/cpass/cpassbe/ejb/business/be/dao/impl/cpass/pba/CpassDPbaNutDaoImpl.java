...
/**
 * Data Access Object implementor for the entity CpassDPbaNuts
 */
@ApplicationScoped
public class CpassDPbaNutDaoImpl extends BaseEntityDaoImpl<Integer, CpassDPbaNuts> implements CpassDPbaNutDao {
	// Nothing to add
}
