...
public class GetAusaService extends BaseDecodificaService<GetAusaRequest, GetAusaResponse> {
	/**
	 * Constructor
	 * @param configurationHelper the helper for the configuration
	 * @param decodificaDad the DAD for the decodifica
	 */
	public GetAusaService(ConfigurationHelper configurationHelper, DecodificaDad decodificaDad) {
		super(configurationHelper, decodificaDad);
	}

	@Override
	protected void execute() {
		final List<Ausa> risorsas = decodificaDad.getAusas();
		response.setAusas(risorsas);
	}
