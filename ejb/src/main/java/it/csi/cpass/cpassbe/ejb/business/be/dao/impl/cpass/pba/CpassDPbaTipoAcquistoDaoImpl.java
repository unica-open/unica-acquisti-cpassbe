...
/**
 * Data Access Object implementor for the entity CpassDPbaAusa
 */
@ApplicationScoped
public class CpassDPbaTipoAcquistoDaoImpl extends BaseEntityDaoImpl<Integer, CpassDPbaTipoAcquisto> implements CpassDPbaTipoAcquistoDao {
	// Nothing to add
}
