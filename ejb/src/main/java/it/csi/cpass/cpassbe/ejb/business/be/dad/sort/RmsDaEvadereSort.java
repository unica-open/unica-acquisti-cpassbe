...
public enum RmsDaEvadereSort  implements JpaSort {
	 ...
	 */
	private RmsDaEvadereSort(String modelName, String queryName) {
	 ...
	 * @return the sort
	 */
	public static RmsDaEvadereSort byModelName(String modelName) {
		for(final RmsDaEvadereSort is : RmsDaEvadereSort.values()) {
