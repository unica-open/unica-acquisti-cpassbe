 ...
 */
public class GetTipoProceduraService extends BaseDecodificaService<GetTipoProceduraRequest, GetTipoProceduraResponse> {
	 ...
	 */
	public GetTipoProceduraService(ConfigurationHelper configurationHelper, DecodificaDad decodificaDad) {
		super(configurationHelper, decodificaDad);
	}

	@Override
	protected void execute() {
		response.setTipoProceduras(decodificaDad.getTipoProceduras());
	}
