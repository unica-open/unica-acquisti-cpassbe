...
/**
 * Data Access Object implementor for the entity CpassDPbaPriorita
 */
@ApplicationScoped
public class CpassDPbaPrioritaDaoImpl extends BaseEntityDaoImpl<Integer, CpassDPbaPriorita> implements CpassDPbaPrioritaDao {
	// Nothing to add
}
