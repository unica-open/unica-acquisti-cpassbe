 ...
 */
@Mapper(uses = {  StatoMapper.class, RigaRmsMapper.class, EnteMapper.class, SettoreCustomMapper.class, UtenteMapper.class})
public interface TestataRmsMapper extends BaseMapperInterface<TestataRms, CpassTRmsTestataRms> {
