 ...
 */
public class PostArchivioRupsByInterventoRequest implements BaseRequest {
	private UUID idRup;
	 ...
	 */
	public PostArchivioRupsByInterventoRequest(UUID idRup, List<Intervento> listaInterventi) {
