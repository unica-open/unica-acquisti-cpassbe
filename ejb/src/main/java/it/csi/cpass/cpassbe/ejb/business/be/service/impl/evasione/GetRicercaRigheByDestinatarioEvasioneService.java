...
public class GetRicercaRigheByDestinatarioEvasioneService
	...
	protected void execute() {
		List<RigaEvasione> righe = rigaEvasioneDad.getRigheByDestinatarioEvasione(request.getIdDestinatarioEvasione());
		
		for(RigaEvasione riga : righe) {
			BigDecimal totaleEvaso = rigaEvasioneDad.calcolaTotale(riga.getRigaOrdine().getId());
