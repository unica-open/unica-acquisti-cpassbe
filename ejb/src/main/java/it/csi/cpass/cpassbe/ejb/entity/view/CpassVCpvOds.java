...
/**
 * Entity for VIEW cpass_v_cpv_ods
 */
@Entity
@Table(name="cpass_v_cpv_ods")
@NamedQuery(name="CpassVCpvOds.findAll", query="SELECT c FROM CpassVCpvOds c")
public class CpassVCpvOds implements Serializable, BaseEntity<Long> {
	private static final long serialVersionUID = 1L;

	@Id
	@Column(name="id_v_cpv_ods")
	private Long idVCpv;
