...
/**
 * Base class for services for /elaborazione path
 * @param <Q> the request type
 * @param <R> the response type
 */
public abstract class BaseElaborazioneService<Q extends BaseRequest, R extends BaseResponse> extends BaseService<Q, R> {

	/** Data Access Delegate for Elaborazione */
	 ...
	 */
	protected BaseElaborazioneService(ConfigurationHelper configurationHelper, ElaborazioneDad elaborazioneDad) {
