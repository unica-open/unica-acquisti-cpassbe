...
import it.csi.cpass.cpassbe.mit.client.auth.ApiKeyAuth;
import it.csi.cpass.cpassbe.mit.client.auth.Authentication;
import it.csi.cpass.cpassbe.mit.client.auth.HttpBasicAuth;
import it.csi.cpass.cpassbe.mit.client.auth.OAuth;
...
public class ApiClient {
	...
	public ApiClient() {
		...
		httpClient.setConnectTimeout((long)20 * 60 * 1000, TimeUnit.MILLISECONDS);
		verifyingSsl = true;
	...
	public <T> ApiResponse<T> execute(Call call, Type returnType) throws ApiException {
		//System.out.println("ApiClient execute Start");
		try {
			final Response response = call.execute();
			final T data = handleResponse(response, returnType);
			//System.out.println("ApiClient execute Stop");
	...
	public <T> T handleResponse(Response response, Type returnType) throws ApiException {
		//System.out.println("ApiClient handleResponse Start");
	...
	public Call buildCall(String path, String method, List<Pair> queryParams, Object body, Map<String, String> headerParams, Map<String, Object> formParams, String[] authNames, ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		...
		log.info("buildCall", "prima di newCall");
		final Call ris = httpClient.newCall(request);
		log.info("buildCall", "dopo di newCall");
		return ris;
	}
