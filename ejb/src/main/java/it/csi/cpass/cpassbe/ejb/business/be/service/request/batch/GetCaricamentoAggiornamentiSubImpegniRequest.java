 ...
 */
public class GetCaricamentoAggiornamentiSubImpegniRequest implements BaseRequest {
	String ente;
	Integer numelab;
	String dataElab;
	public GetCaricamentoAggiornamentiSubImpegniRequest(String ente,Integer numelab,String dataElab) {
		super();
		this.ente = ente;
