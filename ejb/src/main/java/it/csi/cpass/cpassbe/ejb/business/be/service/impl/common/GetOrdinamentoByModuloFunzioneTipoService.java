...
public class GetOrdinamentoByModuloFunzioneTipoService extends BaseCommonService<GetOrdinamentoByModuloFunzioneTipoRequest, GetOrdinamentoByModuloFunzioneTipoResponse> {
	 ...
	 */
	public GetOrdinamentoByModuloFunzioneTipoService(ConfigurationHelper configurationHelper, CommonDad commonDad) {
	...
	protected void execute() {
		String ordinamento = commonDad.getOrdinamentoByModuloFunzioneTipo(request.getModulo(), request.getFunzione(),request.getTipo(),request.getListMetadatiFunzione());
