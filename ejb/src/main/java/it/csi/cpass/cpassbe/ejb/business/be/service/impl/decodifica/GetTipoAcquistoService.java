...
/**
 * Lettura TipoAcquisto
 */

public class GetTipoAcquistoService extends BaseDecodificaService<GetTipoAcquistoRequest, GetTipoAcquistoResponse> {
	/**
	 * Constructor
	 * @param configurationHelper the helper for the configuration
	 * @param decodificaDad the DAD for the decodifica
	 */
	public GetTipoAcquistoService(ConfigurationHelper configurationHelper, DecodificaDad decodificaDad) {
		super(configurationHelper, decodificaDad);
	}

	@Override
	protected void execute() {
		final List<TipoAcquisto> lista = decodificaDad.getTipoAcquistos();
		response.setListaTipoAcquisto(lista);
	}
