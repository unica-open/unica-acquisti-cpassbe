 ...
 */
public class PostControlloCapofilaXCopiaInterventiRequest implements BaseRequest {
	private final List<Intervento> interventi;

	/**
	 * @param interventi
	 */
	public PostControlloCapofilaXCopiaInterventiRequest(List<Intervento> interventi) {
