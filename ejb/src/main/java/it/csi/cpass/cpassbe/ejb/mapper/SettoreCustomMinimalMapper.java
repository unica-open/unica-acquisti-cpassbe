...
public abstract class SettoreCustomMinimalMapper implements BaseMapperInterface<Settore, CpassTSettore> {
	...
	public Settore toModel(CpassTSettore entity) {
		 ...
		 */
		/*
		List<Cdc> listaCdc = new ArrayList<Cdc>();
		if(entity.getCpassRSettoreCdcs()!= null) {
			for(CpassRSettoreCdc cpassRSettoreCdcs : entity.getCpassRSettoreCdcs()) {
				if(cpassRSettoreCdcs.getDataCancellazione() == null) {
					CpassTCdc cpassTCdc = cpassRSettoreCdcs.getCpassTCdc();
		...
		/*
		List<AooActa> listaAooActa = new ArrayList<AooActa>();
		if(entity.getCpassRSettoreAooActas()!= null) {
			for(CpassRSettoreAooActa cpassRSettoreAooActa : entity.getCpassRSettoreAooActas()) {
				CpassDAooActa cpassDAooActa = cpassRSettoreAooActa.getCpassDAooActa();
