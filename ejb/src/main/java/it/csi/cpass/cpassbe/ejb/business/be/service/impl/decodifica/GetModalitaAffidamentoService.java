 ...
 */
public class GetModalitaAffidamentoService extends BaseDecodificaService<GetModalitaAffidamentoRequest, GetModalitaAffidamentoResponse> {
	 ...
	 */
	public GetModalitaAffidamentoService(ConfigurationHelper configurationHelper, DecodificaDad decodificaDad) {
		super(configurationHelper, decodificaDad);
	}

	@Override
	protected void execute() {
		final List<ModalitaAffidamento> modalitaAffidamentos = decodificaDad.getModalitaAffidamentos();
		response.setModalitaAffidamentos(modalitaAffidamentos);
	}
