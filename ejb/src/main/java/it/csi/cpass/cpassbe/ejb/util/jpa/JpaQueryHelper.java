...
public final class JpaQueryHelper {
	 ...
	 * @param fieldValue the field value
	 */
	public static void andFieldLike(StringBuilder jpql, Map<String, Object> params, String fieldName, String parameterAlias, String fieldValue) {
		if(fieldValue == null) {
			return;
		}
		...
		jpql.append(" AND ");
		jpql.append(toJpqlSearchLike(fieldName, "CONCAT('%', :" + parameterAlias + ", '%')"));
		jpql.append(" ");
		params.put(parameterAlias, tmp);
	}

	/**
	 * Creates a JPQL LIKE string
	 * @param jpqlParamA the first parameter
	 * @param jpqlParamB the second parameter
	...
	/**
	 * Creates a JPQL search parameter
	 * @param jpqlParam the parameter
	 * @return the normalized string parameter
	 */
