...
public interface CpassTSubimpegnoDao extends BaseAuditedEntityDao<UUID, CpassTSubimpegno> {
	 ...
	 * Finds a Subimpegno
	 */
	CpassTSubimpegno getSubimpegnoByChiaveLogica(Integer annoEsercizio, Integer anno, Integer numero, UUID enteId, Integer subimpegnoAnno, Integer subimpegnoNumero);
