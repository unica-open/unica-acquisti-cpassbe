 ...
 */
public class GetTipoProceduraOrdService extends BaseDecodificaService<GetTipoProceduraOrdRequest, GetTipoProceduraOrdResponse> {
	 ...
	 */
	public GetTipoProceduraOrdService(ConfigurationHelper configurationHelper, DecodificaDad decodificaDad) {
	...
	protected void execute() {
		...
		response.setTipoProceduras(decodificaDad.getTipoProceduraOrds(enteId));
	}
