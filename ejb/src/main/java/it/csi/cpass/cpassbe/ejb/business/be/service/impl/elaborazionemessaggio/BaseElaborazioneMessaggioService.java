...
/**
 * Base class for services for /elaborazioneMessaggio path
 * @param <Q> the request type
 * @param <R> the response type
 */
public abstract class BaseElaborazioneMessaggioService<Q extends BaseRequest, R extends BaseResponse> extends BaseService<Q, R> {

	/** Data Access Delegate for ElaborazioneMessaggio */
	 ...
	 */
	protected BaseElaborazioneMessaggioService(ConfigurationHelper configurationHelper, ElaborazioneMessaggioDad elaborazioneMessaggioDad) {
