...
public class GetUnitaMisuraService extends BaseDecodificaService<GetUnitaMisuraRequest, GetUnitaMisuraResponse> {
	/**
	 * Constructor
	 * @param configurationHelper the helper for the configuration
	 * @param decodificaDad the DAD for the decodifica
	 */
	public GetUnitaMisuraService(ConfigurationHelper configurationHelper, DecodificaDad decodificaDad) {
		super(configurationHelper, decodificaDad);
	}

	@Override
	protected void execute() {
		final List<UnitaMisura> lista = decodificaDad.getUnitaMisura();
