...
@Mapper(uses = { OggettiSpesaMapper.class,SettoreCustomMapper.class,EnteMapper.class,StatoMapper.class,MagazzinoMapper.class})
public interface RigaRmsMapper extends BaseMapperInterface<RigaRms, CpassTRmsRigaRms> {
	...
	CpassTRmsRigaRms cloneToEntity(CpassTRmsRigaRms entity);
	RigaRms cloneToModel(RigaRms model);
