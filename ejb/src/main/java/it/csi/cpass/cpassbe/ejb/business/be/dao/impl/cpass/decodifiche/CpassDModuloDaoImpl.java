...
public class CpassDModuloDaoImpl extends BaseEntityDaoImpl<Integer, CpassDModulo> implements CpassDModuloDao {
	...
	public List<CpassDModulo> getByUtenteIdAndSettoreId(UUID utenteId, UUID settoreId) {
		...
		return getByUtenteIdAndSettoreId (utenteId, settoreId, new Date());
		//		Date now = new Date();
		...
		//			.append("    AND rrm.cpassTEnte = rrus.cpassRUtenteSettore.cpassTSettore.cpassTEnte ");
	...
	@Override
	public List<CpassDModulo> getByUtenteIdAndSettoreId(UUID utenteId, UUID settoreId, Date checkDate) {
		...
		final StringBuilder jpql = new StringBuilder()
				...
				.append("    AND rrus.cpassDRuolo = rrm.cpassDRuolo ")
				.append("    AND rrm.cpassTEnte = rrus.cpassRUtenteSettore.cpassTSettore.cpassTEnte ");
		//issue-288 eliminato il controllo sulla validità data inizio
		JpaQueryHelper.andCheckDateValiditaFine(jpql, params, "rrus", "checkDate", checkDate);
		...
		final TypedQuery<CpassDModulo> query = composeTypedQuery(jpql, params);
		return query.getResultList();
	}
