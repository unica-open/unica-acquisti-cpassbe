...
public class GetElaborazioneMessaggioByIdService extends BaseElaborazioneMessaggioService<GetElaborazioneMessaggioByIdRequest, GetElaborazioneMessaggioByIdResponse> {
	...
	protected void execute() {
		final ElaborazioneMessaggio elaborazioneMessaggio = new ElaborazioneMessaggio();//elaborazioneDad.getElaborazione(request.getId()).orElseThrow(() -> new NotFoundException("elaborazione"));
