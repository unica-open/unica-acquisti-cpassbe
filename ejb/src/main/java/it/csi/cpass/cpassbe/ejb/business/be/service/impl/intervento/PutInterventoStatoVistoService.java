...
public class PutInterventoStatoVistoService extends BaseInterventoService<PutInterventoStatoVistoRequest, PutInterventoStatoVistoResponse> {
	 ...
	 */
	public PutInterventoStatoVistoService(ConfigurationHelper configurationHelper, InterventoDad interventoDad, UtenteDad utenteDad,DecodificaDad decodificaDad) {
	...
	protected void execute() {
		...
		stato           = isEntityPresent(() -> decodificaDad.getStato(CpassStatiEnum.INT_VISTO.getCostante(), CpassEnum.INTERVENTO.getCostante()), "stato");
