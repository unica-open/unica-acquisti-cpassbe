...
public interface CpassTOrdRigaEvasioneDao extends BaseAuditedEntityDao<UUID, CpassTOrdRigaEvasione> {
	...
	BigDecimal calcolaQuantitaEvasa(UUID rigaOrdineId);

	List<CpassTOrdRigaEvasione> findByIdOrdineEDocumento(List<UUID> idOrdines, UUID idOrdine, Integer fatturaAnno, String fatturaNumero, String fatturaTipo, String fatturaCodice);

	BigDecimal getTotQtaEvasa(UUID rigaOrdineId);

	BigDecimal calcolaTotaleEsclusaEvasione(UUID rigaOrdineId, UUID rigaEvasioneId);
}
