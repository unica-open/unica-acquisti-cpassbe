...
public class CpassVOrdine implements Serializable, BaseEntity<Long> {
	...
	@Column(name="stato_destinatario_id")
	private Integer statoDestinatarioId;
	...
	/**
	 * @return the statoDestinatarioId
	 */
	public Integer getStatoDestinatarioId() {
		return statoDestinatarioId;
	}

	/**
	 * @param statoDestinatarioId the statoDestinatarioId to set
	 */
	public void setStatoDestinatarioId(Integer statoDestinatarioId) {
		this.statoDestinatarioId = statoDestinatarioId;
	}
	...
	/**
	 * @return the provvedimentoSettore
	 */
	...
	/**
	 * @param provvedimentoSettore the provvedimentoSettore to set
	 */
