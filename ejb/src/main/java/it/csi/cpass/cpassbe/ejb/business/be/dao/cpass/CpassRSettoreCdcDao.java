...
public interface CpassRSettoreCdcDao extends BaseAuditedEntityDao<Integer, CpassRSettoreCdc> {

	List<CpassRSettoreCdc> findByCdcIdSettId(UUID settoreId, Integer cdcId);
