 ...
 */
public interface CpassTPbaAcquistiDaTrasmettereDao extends BaseEntityDao<Integer, CpassTPbaAcquistiDaTrasmettere> {

	List<CpassTPbaAcquistiDaTrasmettere> acquistiDaTrasmettereByProgrammaId(UUID idProgramma);
